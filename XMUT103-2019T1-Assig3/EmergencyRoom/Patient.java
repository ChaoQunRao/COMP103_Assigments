...
public class Patient implements Comparable<Patient>{
    ...
    private int arrival;
    private int priority;  // 1 is highest priority, 3 is lowest  
    private List<String> treatments = new ArrayList<String>();
    private List<Integer> treatmentTimes = new ArrayList<Integer>();
    private Map<String,int[]> waitingTimes = new HashMap<String,int[]>();
    ...
    public Patient(int time, int triPriority){
        ...
        for(String name:this.treatments){
            waitingTimes.put(name, new int[2]);
        }
    }

    public String getName(){return name;}
    public int treatmentTime(){return treatmentTime;}
    public int getArrivalTime(){return arrival;}
    public int getPriority(){return priority;}
    public int getTotalTreatmentTime(){return totalTreatmentTime;}
    public Map<String,int[]> getTreatmentsTime(){return this.waitingTimes;}    
    public int totalWaitingTime(){return this.totalWaitTime;}
    public int waitingTime(){return this.waitTime;}
    public String name(){return this.name;}
    public List<String> allTreatments(){return this.treatments;}
    /**
    ...
    public void waitForATick(){
        String name = treatments.get(currentTreatment);
        int[] time = waitingTimes.get(name);
        time[0] = time[0] + 1;
        waitingTimes.put(name, time);
        totalWaitTime++;
        treatmentTime++;
        waitTime++;
    }
    ...
    public void makeRandomTreatments(){
        ...
        for (int i=0; i<n; i++){
            ...
            if (num<0.05){
                ...
                treatments.add("ICU");
                treatmentTimes.add(randomTreatmentTime(300));
            }
        }
